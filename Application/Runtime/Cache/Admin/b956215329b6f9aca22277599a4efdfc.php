        ...
        <div class="layui-field-box">
            ...
            <table class="layui-table" lay-even>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php if($vo['hide']): ?><span class="layui-btn confirm" data-info="你确定显示当前菜单么？" data-id="<?php echo ($vo['id']); ?>" data-url="<?php echo U('open');?>">显示</span>
                                <?php else: ?>
                                <span class="layui-btn layui-btn-danger confirm" data-info="你确定隐藏当前菜单么？" data-id="<?php echo ($vo['id']); ?>" data-url="<?php echo U('close');?>">隐藏</span><?php endif; ?>
