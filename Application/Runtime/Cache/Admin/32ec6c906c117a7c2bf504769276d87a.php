...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/ApiAdmin/Public/layui/css/layui.css" />
    <style>
        /* login */
        .login-body {
            background: url("/ApiAdmin/Public/images/bg.png") repeat fixed;
        }
        .login-box {
            position: fixed;
            top: 0;
...
<div class="login-box">
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            <h3><?php echo C('APP_NAME');?>管理后台&nbsp;<span class="version"><?php echo C('APP_VERSION');?></span></h3>
        </div>
        <div class="layui-form-item">
...
<script src="/ApiAdmin/Public/js/gt.js"></script>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: "<?php echo U('Verification/gt');?>?t=" + (new Date()).getTime(),
        type: "get",
        dataType: "json",
